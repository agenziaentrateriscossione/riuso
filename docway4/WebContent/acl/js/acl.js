...
/**
 * apertura box di gestione multiUtenza di Account
 */
function multiuserOpen(nuserID, extraID, label) {
	$("#lunch_" + nuserID + " a").attr("href", "javascript:multiuserClose('" + nuserID + "', '" + extraID + "', '" + label.replace('\'', '\\\'') + "');");
	$("#nuser_" + nuserID + "_" + extraID).show();
}

/**
 * chiusura box di gestione multiUtenza di Account
 */
function multiuserClose(nuserID, extraID, label) {
	$("#nuser_" + nuserID + "_" + extraID).hide();
	$("#lunch_" + nuserID + " a").attr("href", "javascript:multiuserOpen('" + nuserID + "', '" + extraID + "', '" + label.replace('\'', '\\\'') + "');");
}
