...
function activateLookupControl() {
    $('.lookup-field, .th-field, .tag-field').on('input blur', function (e) {
        ...
        if (e.type == 'input') {
            ...
            $('.lookup-button').attr('disabled', 'disabled');
        } else {
            setTimeout(function () {
                $('.docedit #templateForm\\:saveBtn').removeAttr('disabled');
                $('.docedit #templateForm\\:saveBozzaBtn').removeAttr('disabled');
                $('.docedit #templateForm\\:protocoolaBtn').removeAttr('disabled');
