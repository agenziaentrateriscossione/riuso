...
public class QueryPersonaEsterna extends AclQuery {
	...
	private String persest_nrecord;
	...
	private String persest_listaDistribuzione;
	...
	public String queryPlain() throws Exception {
		...
		String query =  "";
		query +=  addQueryField("xml,/persona_esterna/@nrecord", persest_nrecord);
		...
		query +=  addQueryField("persest_listaDistribuzione", persest_listaDistribuzione);
	...
	public String getPersest_nrecord() {
		return persest_nrecord;
	}

	public void setPersest_nrecord(String persest_nrecord) {
		this.persest_nrecord = persest_nrecord;
	}
	...
	public String resetQuery() {
		...
		this.persest_listaDistribuzione = null;
	...
	public String openIndexListaDistribuzione() throws Exception {
		this.focusElement = "persest_listaDistribuzione";
		this.openIndex("persest_listaDistribuzione", this.persest_listaDistribuzione, "0", " ");
		return null;
	}
	...
	public String getPersest_listaDistribuzione() {
		return persest_listaDistribuzione;
	}

	public void setPersest_listaDistribuzione(String persest_listaDistribuzione) {
		this.persest_listaDistribuzione = persest_listaDistribuzione;
	}
}
