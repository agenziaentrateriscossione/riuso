...
public class QueryAoo extends AclQuery {
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query +=  addQueryField("XML,/aoo/@nrecord", aoo_nrecord);
	...
	public String resetQuery() {
		...
		this.aoo_nrecord = null;
		this.aoo_nome = null;
		return null;
	}

	public String getAoo_nrecord() {
		return aoo_nrecord;
	}

	public void setAoo_nrecord(String aoo_nrecord) {
		this.aoo_nrecord = aoo_nrecord;
	}
