...
public class QueryRuolo extends AclQuery {
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query +=  addQueryField("ruoli_nrecord", ruoli_nrecord);
	...
	public String resetQuery() {
		...
		this.ruoli_nrecord = null;
		this.ruoli_nome = null;
		this.ruoli_descrizione = null;
		return null;
	}

	public String getRuoli_nrecord() {
		return ruoli_nrecord;
	}

	public void setRuoli_nrecord(String ruoli_nrecord) {
		this.ruoli_nrecord = ruoli_nrecord;
	}
