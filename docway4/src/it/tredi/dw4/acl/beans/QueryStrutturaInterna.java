...
public class QueryStrutturaInterna extends AclQuery {
	...
	private String struint_nrecord;
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query +=  addQueryField("xml,/struttura_interna/@nrecord", struint_nrecord);
	...
	public String getStruint_nrecord() {
		return struint_nrecord;
	}

	public void setStruint_nrecord(String struint_nrecord) {
		this.struint_nrecord = struint_nrecord;
	}
