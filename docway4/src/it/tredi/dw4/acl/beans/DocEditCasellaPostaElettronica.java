...
public class DocEditCasellaPostaElettronica extends AclDocEdit {
	...
	private boolean abilitaAssegnazioneCcByEmailAddresses = false;
	...
	protected void initData(Document dom) {
    	...
    	this.abilitaAssegnazioneCcByEmailAddresses = StringUtil.booleanValue(XMLUtil.parseStrictAttribute(dom, "/response/@abilitaAssegnazioneCcByEmailAddresses"));
	...
	public boolean isAbilitaAssegnazioneCcByEmailAddresses() {
		return abilitaAssegnazioneCcByEmailAddresses;
	}

	public void setAbilitaAssegnazioneCcByEmailAddresses(boolean abilitaAssegnazioneCcByEmailAddresses) {
		this.abilitaAssegnazioneCcByEmailAddresses = abilitaAssegnazioneCcByEmailAddresses;
	}
