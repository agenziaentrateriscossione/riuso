...
public class QueryProfilo extends AclQuery {
	...
	private String profilo_nrecord;
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query += addQueryField("xml,/persona_interna/@nrecord", profilo_nrecord);
	...
	public String resetQuery() {
		...
		this.profilo_nrecord = null;
		this.profilo_matricola = null;
		this.profilo_nome = null;
		return null;
	}

	public String getProfilo_nrecord() {
		return profilo_nrecord;
	}

	public void setProfilo_nrecord(String profilo_nrecord) {
		this.profilo_nrecord = profilo_nrecord;
	}
