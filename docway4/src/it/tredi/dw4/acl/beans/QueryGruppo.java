...
public class QueryGruppo extends AclQuery {
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query +=  addQueryField("xml,/gruppo/@nrecord", gruppi_nrecord);
	...
	public String resetQuery() {
		...
		this.gruppi_nrecord = null;
		this.gruppi_nome = null;
		this.gruppi_descrizionegr = null;
		return null;
	}

	public String getGruppi_nrecord() {
		return gruppi_nrecord;
	}

	public void setGruppi_nrecord(String gruppi_nrecord) {
		this.gruppi_nrecord = gruppi_nrecord;
	}
