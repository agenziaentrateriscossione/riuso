...
public class QueryCasellaPostaElettronica extends AclQuery {
	...
	private String casellaPostaElettronica_nrecord;
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query +=  addQueryField("XML,/casellaPostaElettronica/@nrecord", casellaPostaElettronica_nrecord);
	...
	public String resetQuery() {
		...
		this.casellaPostaElettronica_nrecord = null;
	...
	public String getCasellaPostaElettronica_nrecord() {
		return casellaPostaElettronica_nrecord;
	}

	public void setCasellaPostaElettronica_nrecord(String casellaPostaElettronica_nrecord) {
		this.casellaPostaElettronica_nrecord = casellaPostaElettronica_nrecord;
	}
