...
public class QueryStrutturaEsterna extends AclQuery {
	...
	private String struest_nrecord;
	...
	private String struest_listaDistribuzione;
	...
	public String queryPlain() throws Exception {
		...
		String query =  "";
		query +=  addQueryField("xml,/struttura_esterna/@nrecord", struest_nrecord);
		...
		query +=  addQueryField("struest_listaDistribuzione", struest_listaDistribuzione);
	...
	public String getStruest_nrecord() {
		return struest_nrecord;
	}

	public void setStruest_nrecord(String struest_nrecord) {
		this.struest_nrecord = struest_nrecord;
	}
	...
	public String openIndexListaDistribuzione() throws Exception {
		this.openIndex("struest_listaDistribuzione", this.struest_listaDistribuzione, "0", " ");
		return null;
	}
	public String getStruest_listaDistribuzione() {
		return struest_listaDistribuzione;
	}

	public void setStruest_listaDistribuzione(String struest_listaDistribuzione) {
		this.struest_listaDistribuzione = struest_listaDistribuzione;
	}
