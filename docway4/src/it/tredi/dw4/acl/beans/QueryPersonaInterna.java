...
public class QueryPersonaInterna extends AclQuery {
	...
	private String persint_nrecord;
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query += addQueryField("xml,/persona_interna/@nrecord", persint_nrecord);
	...
	public String getPersint_nrecord() {
		return persint_nrecord;
	}

	public void setPersint_nrecord(String persint_nrecord) {
		this.persint_nrecord = persint_nrecord;
	}
