...
public class Menu extends Page {
	...
	public String gotoTableQListaDist() throws Exception {
		formsAdapter.gotoTableQ("lista_dist", false);

		XMLDocumento responseDoc = formsAdapter.getDefaultForm().executePOST(getUserBean());
		return buildSpecificQueryPageAndReturnNavigationRule("lista_dist", responseDoc);
	}
	...
	public String insTableDocListaDist() throws Exception {
		formsAdapter.insTableDoc("lista_dist");
		XMLDocumento responseDoc = formsAdapter.getDefaultForm().executePOST(getUserBean());
		
		return buildSpecificDocEditPageAndReturnNavigationRule("lista_dist", responseDoc, false);
	}
