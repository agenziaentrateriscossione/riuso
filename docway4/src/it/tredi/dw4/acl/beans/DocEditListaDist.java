...
public class DocEditListaDist extends AclDocEdit {
	private AclDocEditFormsAdapter formsAdapter;
	private ListaDistribuzione listaDistribuzione = new ListaDistribuzione();
	...
	public DocEditListaDist() throws Exception {
	...
	public String saveDocument() throws Exception {
		try {
			...
			ShowdocListaDist showdocListaDist = new ShowdocListaDist();
			showdocListaDist.getFormsAdapter().fillFormsFromResponse(response);
			showdocListaDist.init(response.getDocument());
			
			setSessionAttribute("showdocListaDist", showdocListaDist);		
