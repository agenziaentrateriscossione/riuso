...
public class AclHome extends AclQuery {
	...
	private boolean lista_distribuzione = false;
	...
	*/	
	...
	public String search() throws Exception{
		try {
			...
			if (lista_distribuzione)extra = addQueryFieldOR(extra, "[UD,/xw/@UdType]=\"lista_dist\"");
			...
			if (extra.length() == 0) {
				...
				extra = addQueryFieldOR(extra, "[UD,/xw/@UdType]=\"lista_dist\"");
			}
	...
	public boolean isLista_distribuzione() {
		return lista_distribuzione;
	}

	public void setLista_distribuzione(boolean lista_distribuzione) {
		this.lista_distribuzione = lista_distribuzione;
	}
...
*/	
	public String clearForm() {
		...
		this.comune = false;
		this.gruppo = false;
		this.lista_distribuzione = false;
		//this.pec = false;
		this.createDateFrom = "";
		this.createDateTo = "";
		this.updateDateFrom = "";
