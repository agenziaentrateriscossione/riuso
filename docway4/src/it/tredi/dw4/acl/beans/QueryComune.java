...
public class QueryComune extends AclQuery {
	...
	public String queryPlain() throws Exception {
		String query =  "";
		query +=  addQueryField("xml,/comune/@nrecord", comuni_nrecord);
	...
	public String getComuni_nrecord() {
		return comuni_nrecord;
	}

	public void setComuni_nrecord(String comuni_nrecord) {
		this.comuni_nrecord = comuni_nrecord;
	}
