...
public class Responsabile extends XmlEntity {
    ...
    // mbernardini 27/04/2020 : recupero assegnatari in CC del doc tramite analisi degli indirizzi email mittente e/o destinatari del documento
    // Aggiunti in questo oggetto (anche se si riferiscono ad assegnatari in CC perche' completa la gestione la property daCopiaConoscenza)
    private String ccDaDestinatario;
    private String ccDaMittente;
    ...
    public Responsabile init(Document domResponsabile) {
    	...
    	this.ccDaDestinatario		= XMLUtil.parseAttribute(domResponsabile, "responsabile/@ccDaDestinatario");
    	this.ccDaMittente			= XMLUtil.parseAttribute(domResponsabile, "responsabile/@ccDaMittente");
    ...
    public Map<String, String> asFormAdapterParams(String prefix){
    	...
    	if (null != this.ccDaDestinatario) 	params.put(prefix+".@ccDaDestinatario", this.ccDaDestinatario);
    	if (null != this.ccDaMittente) 		params.put(prefix+".@ccDaMittente", this.ccDaMittente);
    	return params;
    }
	...
	public String getCcDaDestinatario() {
		return ccDaDestinatario;
	}

	public void setCcDaDestinatario(String ccDaDestinatario) {
		this.ccDaDestinatario = ccDaDestinatario;
	}

	public String getCcDaMittente() {
		return ccDaMittente;
	}

	public void setCcDaMittente(String ccDaMittente) {
		this.ccDaMittente = ccDaMittente;
	}
