...
public class History extends XmlEntity {
	...
	private AdditionalHistoryInfos additionalInfos;
	public History() {}
    ...
    public History init(Document dom) {
    	...
    	this.additionalInfos = (AdditionalHistoryInfos) XMLUtil.parseElement(dom, "item/additional_infos", new AdditionalHistoryInfos());
        return this;
    }
	...
	public AdditionalHistoryInfos getAdditionalInfos() {
		return additionalInfos;
	}

	public void setAdditionalInfos(AdditionalHistoryInfos additionalInfos) {
