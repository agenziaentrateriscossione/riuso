...
public class Doc extends XmlEntity {
	...
	protected String oggettoFromResponse;
	...
	// mbernardini 27/03/2020 : gestione dei documenti derivanti da riconciliazione
	private boolean flagRiconciliazione = false;
    ...
    // dpranteda 29/11/2019 : gestione flusso PEC MANAGER
    private PecManager pecManager = new PecManager();
	...
	public XmlEntity init(Document dom, String tipo) {
		...
		this.oggettoFromResponse = XMLUtil.parseElement(dom, "doc/oggetto", false);
		...
		this.flagRiconciliazione = StringUtil.booleanValue(XMLUtil.parseStrictAttribute(dom, xpath+"/@riconciliazione", "")); 
		...
		this.pecManager.init(XMLUtil.createDocument(dom, xpath+"/pecmanager"));
	...
	public String getOggettoFromResponse() {
		return oggettoFromResponse;
	}

	public void setOggettoFromResponse(String oggettoFromResponse) {
		this.oggettoFromResponse = oggettoFromResponse;
	}
