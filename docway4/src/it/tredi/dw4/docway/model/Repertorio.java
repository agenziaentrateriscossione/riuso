...
public class Repertorio extends XmlEntity {
    ...
    public Repertorio init(Document dom) {
    	...
    	this.legislatura = XMLUtil.parseAttribute(dom, "repertorio/@legislatura");
    ...
    public Map<String, String> asFormAdapterParams(String prefix){
    	...
    	if (this.legislatura != null && !this.legislatura.isEmpty())
    		params.put(prefix+".@legislatura", this.legislatura);
    	return params;
    }
