...
public class RifEsterno extends XmlEntity {
    ...
    private boolean vincolatoListaDist = false; // identifica se il riferimento esterno è stato vincolato tramite una lista di distribuzione
	...
	public boolean isVincolatoListaDist() {
		return vincolatoListaDist;
	}

	public void setVincolatoListaDist(boolean vincolatoListaDist) {
		this.vincolatoListaDist = vincolatoListaDist;
	}
	...
	/**
	 * Passaggio di stato vincolatoListaDist
	 */
	public void vincolatoListaDistChangeListener(ValueChangeEvent e) {
		if (e.getNewValue() != null) {
			if (((Boolean) e.getNewValue()).booleanValue()) {
				this.vincolatoListaDist = true;
			}else {
				this.vincolatoListaDist = false;
			}
		}
	}
}
