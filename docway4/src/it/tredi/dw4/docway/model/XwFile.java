...
public class XwFile extends XmlEntity {
	...
	// mbernardini 03/06/2020 : TRUE in caso di file xml relativo ad un ordine, FALSE altrimenti
	...
	public XwFile init(Document dom) {
    	...
    	// mbernardini 03/06/2020 : gestione ordini NSO
    	this.nso = this.name.toLowerCase().endsWith(".xml") && NsoUtils.isNsoFile(this.title);
	...
	public void setNso(boolean nso) {
		this.nso = nso;
	}
