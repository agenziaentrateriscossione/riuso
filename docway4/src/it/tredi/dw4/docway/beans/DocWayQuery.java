...
public abstract class DocWayQuery extends Page {
	...
	protected String addQueryField(String query, String value) {
		return QueryUtil.addQueryField(query, value);
	}

	protected String addQueryField(String query, String value, String operator) {
		return QueryUtil.addQueryField(query, value, operator);
	}
	...
	protected String partialQueryField(String query, String value) {
		return QueryUtil.partialQueryField(query, value); 
	}
	 ...
	 */
	protected String addDateRangeQuery(String searchName, String dataFrom, String dataTo) {
		return QueryUtil.addDateRangeQuery(searchName, dataFrom, dataTo);
	}
	 ...
	 */
	protected String addDateRangeQuery(String searchName, String dataFrom, String dataTo, String operator) {
		return QueryUtil.addDateRangeQuery(searchName, dataFrom, dataTo, operator);
	}
	 ...
	 * @param operator operatore da appendere dopo la query
	 */
	protected String addRangeQuery(String searchName, String from, String to, String operator) {
		return QueryUtil.addRangeQuery(searchName, from, to, operator);
	}
	...
	protected String addRangeQuery(String searchName, String[] values, String operator) {
		return QueryUtil.addRangeQuery(searchName, values, operator);
	}
