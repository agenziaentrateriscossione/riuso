...
//	    setGlobalFormRestore('verbo','xverb','pos','selid','dbTable');
	...
	public void insInFasc(String diritto,
						  String physDoc,
						  String nome_persona,
						  String nome_uff,
						  String cod_persona,
						  ...
						  String soggetto,
						  String tipo_uff,
						  boolean skipCheckClassificazione){
//		var iForm;
...
//	    var old_personalView = defaultForm.addParam("personalView.value;
		...
		// tiommi : 23/03/2020 aggiunto skip filtro sulla classificazione se attiva property xdocway: vincoloClassificazioneFascicoloDocumento.disabilita=si
		if (!classif_cod.equals("00/00") && !skipCheckClassificazione){
	...
	/**
	 * Modifica di un documento con forzatura della trasformazione in un altra tipologia
	 * @param tipo
	 */
	public void modifyTableDocNewType(String tipo){
		this.defaultForm.addParam("nuovoTipo", tipo);
		this.modifyTableDoc(false);
	}
...
//	            'classif_sottofasc','classif_cod_sottofasc', 'tipo_uff_sottofasc');
     ...
     * @param descrProcedimento Descrizione del procedimento da mostrare come valore di default
     */
    public void avviaProcedimento(String descrProcedimento)	{
		this.defaultForm.addParam("verbo", "procedimento_response");
		this.defaultForm.addParam("xverb", "@avvioPage");
		this.defaultForm.addParam("descrProcedimento", descrProcedimento);
	}
    
    /**
     * Apertura del popup modale di annullamento della riconciliazione
     */
    public void annullaRiconciliazione(){
		this.defaultForm.addParam("verbo", "documento_response");
		this.defaultForm.addParam("xverb", "@openAnnullaRiconciliazionePage");
	}
