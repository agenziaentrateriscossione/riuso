...
public class DocWayRifIntFormsAdapter extends DocEditFormsAdapter {
	...
	/**
	 * Aggiunta di rif interni ad un documento da flusso PEC MANAGER
	 */
	public void confirmRifIntForPecManager(String tipoRif, boolean sendMailRifInterni, boolean sendMailSelectedRifInterni, String selectedRifInterni, boolean checkNomi, Map<String, String> map) {
		this.defaultForm.addParam("forPecManager", true);
		this.confirmRifInt(tipoRif, sendMailRifInterni, sendMailSelectedRifInterni, selectedRifInterni, checkNomi, map);
	}
