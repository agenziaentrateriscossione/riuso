...
//this.defaultForm.addParam("nodoCopiato", physDoc);
	...
	/**
	 *  PecManager Presa in carico per il documento corrente
	 */
	public void pecManagerPrendoInCarico(String nrecord) {
		defaultForm.addParam("verbo", "docEdit");
		defaultForm.addParam("xverb", "@pecManagerPrendoInCarico");
		defaultForm.addParam("nrecordDoc", nrecord);
	}
	
	/**
	 *  PecManager Lavorato per il documento corrente
	 */
	public void pecManagerLavorato(String nrecord) {
		defaultForm.addParam("verbo", "docEdit");
		defaultForm.addParam("xverb", "@pecManagerLavorato");
		defaultForm.addParam("nrecordDoc", nrecord);
	}
	
	/**
	 *  PecManager Rigettato per il documento corrente
	 */
	public void pecManagerRigettato(String nrecord) {
		this.defaultForm.addParam("nrecordDoc", nrecord);
	    // e' richiesto l'inserimento di un postit
    	this.defaultForm.addParam("toDo", this.defaultForm.getParam("toDo")+"%doPecManagerRigetta%");
	}
}
