...
public class DocEditModifyPersonaInternaAspect extends BaseAddOn {
	...
	public String lookupArchivio() throws Exception {
		try {
			...
			String titolo 		= "xml,/archBridge/@fullDescr"; //titolo 
			String ord 			= "xml(xpart:/archBridge/@fullDescr)"; //ord 
			String campi 		= ".archivi["+num+"].id=xml,/archBridge/@alias " 
										+ "; .archivi["+num+"].descr=xml,/archBridge/@fullDescr"; //campi
			String xq 			= ""; // xq 
			String db 			= ""; //db 
	...
	public String clearLookupArchivio() throws Exception {
		try {
			...
			String campi = ".archivi["+num+"].id=xml,/archBridge/@alias ; .archivi["+num+"].descr=xml,/archBridge/@fullDescr"; //campi
