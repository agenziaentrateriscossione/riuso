...
public class NumFascUtils {
	...
	/**
     * Ritorna i valori impostati come lunghezza del seriale relativo al numero di fascicolo. Gestione di una eventuale
     * variazione della lunghezza su server di produzione.
     * @param lengths Valore ricevuto dal service che indica le lunghezze impostate sull'archivio
     * @return
     */
    public static int[] getNumFascLengths(String lengths) {
    	if (lengths == null || lengths.isEmpty())
    		lengths = "5";
    	String[] str = lengths.split(",");
        ...
        for(int i=0; i<str.length; i++) {
        	try {
        		...
        		Logger.error("Unable to parse num_fasc length from properties... " + e.getMessage(), e);
			}
        }
