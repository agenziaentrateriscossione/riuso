...
/**
 * Converte utilizzato per la formattazione del numero procedimento definito nel formato seguente:
 * {TIPO_PROCEDIMENTO}^{ANNO|LEGISLATURA}{NUMERO_PRECEDUTO_DA_ZERO}
 * Esempi: PDLS^L01800006, Decreto^202000006 
 */
public class ProcNumeroConverter implements Converter {

	@Override
	public Object getAsObject(FacesContext context, UIComponent component, String value) {
		String result = "";
 		try {
 			Logger.debug("ProcNumeroConverter.getAsObject(): input value = " + value);
			...
			if (value.contains("-")) {
 			...
 			Logger.warn("ProcNumeroConverter.getAsObject(): conversion failed (" + e.getMessage() + ")... use " + value);
 			result = value;
 		}
		return result;
	}
