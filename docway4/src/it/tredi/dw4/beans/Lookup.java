...
public abstract class Lookup extends Page {
	...
	private String schedaTitle = "Lookup"; // titolo della scheda ( default Lookup )
	
	public String getSchedaTitle() {
		return schedaTitle;
	}

	public void setSchedaTitle(String schedaTitle) {
		this.schedaTitle = schedaTitle;
	}
